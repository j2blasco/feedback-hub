...
// No longer needed since we're generating a string template
...
class BoundaryConfigGenerator {
  ...
  constructor(srcDir: string = 'src', outputPath: string = 'eslint-boundaries.generated.mjs') {
    this.srcDir = srcDir;
  ...
  public generate(): void {
    ...
    const flatConfig = `// This file is auto-generated by generate-eslint-boundaries.ts
...
export default [
  {
    ...
    settings: {
      'boundaries/elements': ${JSON.stringify(elements, null, 6)}
    },
    rules: {
      'boundaries/element-types': [
        ...
        {
          default: 'disallow',
          rules: ${JSON.stringify(rules, null, 10)}
        }
      ]
    }
  }
...
`;
    ...
    fs.writeFileSync(this.outputPath, flatConfig);
    ...
    console.log('\n🔧 Next steps:');
    console.log('1. Ensure your eslint.config.mjs imports from the generated config');
